    ...
    <div class="body-content">
        ...
        foreach ($vmlist as &$vm) {
            ...
            if (count($nbAction) > 0) {
                ...
                $actionMenu = '<div id="logs' . $vm . '" class="panel-footer"><div class="row"><div class="col-md-12"><label class="control-label">Action in progress</label>' . Html::textarea('ActionResult'.$vm, $log, ['class' => 'form-control', 'rows' => '6']) . '</div></div></div>';
                ...
                $actionMenu = '<div id="logs' . $vm . '" class="panel-footer collapse"><div class="row"><div class="col-md-12"><label class="control-label">Last actions</label>' . Html::textarea('ActionResult'.$vm, $log, ['class' => 'form-control', 'rows' => '6']) . '</div></div>'
                        . '<div class="row"><div class="col-md-12"><label class="control-label">Last errors</label>' . Html::textarea('ActionResultErr'.$vm, $err, ['class' => 'form-control', 'rows' => '6']) . '</div></div></div>';
